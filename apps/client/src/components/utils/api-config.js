...
// WebRTC Stats function
export const getWebRTCStats = async () => {
  try {
    // Mock stats for development/demo mode
    if (API_CONFIG.IS_DEVELOPMENT || !isApiConfigured.webrtc) {
      return {
        ...
        stats: {
          ...
          totalBandwidth: Math.floor(Math.random() * 1000) + 500 // MB
        },
        timestamp: new Date().toISOString()
      };
    }

    // In production, make actual API call to WebRTC server
    const response = await fetch(`${API_CONFIG.SOCKET_IO_URL}/api/stats`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json'
      }
...
export const MOCK_USERS = [
  { id: '1', name: 'Alex Kumar', country: 'India', gender: 'male', isPremium: false, avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face' },
  { id: '2', name: 'Sarah Johnson', country: 'USA', gender: 'female', isPremium: true, avatar: 'https://images.unsplash.com/photo-1494790108755-2616b88d3f13?w=150&h=150&fit=crop&crop=face' },
  { id: '3', name: 'James Wilson', country: 'UK', gender: 'male', isPremium: false, avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face' },
  { id: '4', name: 'Priya Sharma', country: 'India', gender: 'female', isPremium: true, avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&h=150&fit=crop&crop=face' },
  { id: '5', name: 'Michael Brown', country: 'Canada', gender: 'male', isPremium: false, avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop&crop=face' }
];
