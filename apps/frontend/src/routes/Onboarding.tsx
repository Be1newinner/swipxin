...
const slides = [
  {
    ...
    description:
      "Connect with people worldwide through instant 1:1 video calls. Swipe to meet someone new anytime!",
  ...
  },
  {
    ...
    description:
      "Swipe right to connect with the next person or swipe left to stop and return to the home screen. It's that easy!",
  ...
  },
  {
    ...
    description:
      "Upgrade to Premium to filter by specific countries and gender preferences for more targeted connections.",
  ...
  },
  {
    ...
    title: "Token System",
    description:
      "Purchase tokens (₹100 = 150 tokens) to unlock Premium features. 8 tokens are used when premium users swipe.",
        ...
        <Card className="glass w-full max-w-md p-8 text-center space-y-6">
          ...
          <div className="w-full h-48 bg-gradient-to-br from-primary/10 to-accent/10 rounded-2xl flex items-center justify-center">
            <div className="text-center text-muted-foreground">
              ...
              <p className="text-sm">
                Illustration: {slides[currentSlide].image}
              </p>
            </div>
          </div>
        </Card>
