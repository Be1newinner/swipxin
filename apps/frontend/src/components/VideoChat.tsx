...
export function VideoChat({ match, currentUser, onEndCall }: VideoChatProps) {
  ...
  // ✅ Render LiveKit room with your custom UI
  return (
    <LiveKitRoom
...
// ==================== INNER UI COMPONENT (Uses LiveKit Hooks) ====================
...
function VideoCallUI({ currentUser, partner, matchId, onEndCall }: VideoCallUIProps) {
