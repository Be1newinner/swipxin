...
router.post('/find-match', authenticateToken, async (req: Request, res: Response) => {
  try {
...
// End current match
router.post('/end-match/:matchId', authenticateToken, async (req: Request, res: Response) => {
  try {
...
router.get('/current-match', authenticateToken, async (req: Request, res: Response) => {
  try {
    const userId = req.user.id;
...
router.put('/update-status/:matchId', authenticateToken, async (req: Request, res: Response) => {
  try {
    const { matchId } = req.params;
